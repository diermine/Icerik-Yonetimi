...
namespace Joomla\Module\ArticlesTop\Site\Helper;
...
abstract class ArticlesTopHelper
{
	...
	public static function getList(&$params)
	{
       ...
       // User filter
		...
		foreach ($items as &$item)
		{
			...
			$item->introtext = HTMLHelper::_('content.prepare', $item->introtext, '', 'mod_verticalpopularnews.content');
